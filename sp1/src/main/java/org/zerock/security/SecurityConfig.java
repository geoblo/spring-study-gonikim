...
// 이 클래스를 스프링 설정 클래스로 등록하고,
// 내부의 @Bean 메소드들이 반환하는 객체를 스프링 빈으로 스프링 컨테이너에 등록하도록 하는 어노테이션
@Configuration
@Log4j2
@EnableWebSecurity
// 스프링 시큐리티의 웹 보안 기능을 활성화시키고, 이 클래스에서 정의한 보안 설정을 적용하도록 만드는 어노테이션
...
//			handler.accessDeniedPage(null);
	...
	public PasswordEncoder passwordEncoder() {
		return new BCryptPasswordEncoder(); // (참고) 인자값으로 cost factor 넣을 수 있음
